...
public abstract class KeyPadPane extends GridPane {
    // private Buttons
    ...
    protected abstract void registerEventHandlers(EventHandler<ActionEvent> customHandler);
}
