...
* Description: Determine the standard deviation from entered numbers.
*/
...
*/
    ...
    public static double stdDevSample(double value1, double value2, double value3, double value4) {
        // Calculate the mean using the existing average method
        double mean = average(value1, value2, value3, value4);

        
        double sD1 = Math.pow(value1 - mean, 2);
        double sD2 = Math.pow(value2 - mean, 2);
        double sD3 = Math.pow(value3 - mean, 2);
        double sD4 = Math.pow(value4 - mean, 2);

        //standard deviation summation.
        double sumSD = sD1 + sD2 + sD3 +sD4;
        
        return Math.sqrt(sumSD / (4 - 1));
    }
    ...
    public static void main(String[] args) {
        ...
        double stdDev = stdDevSample(d1, d2, d3, d4);
        System.out.printf("The standard deviation of %.2f, %.2f, %.2f, and %.2f is %.5f\n", d1, d2, d3, d4, stdDev);
    }
}
